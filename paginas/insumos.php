  ...
  <div class="productos">
    <div class="row">
      <div class= "col-xs-10 col-sm-6 col-md-4 product">
        <div class = "card">
          <img src="/5L/Proyecto/f2/anexos/img/batablanca.jpg" alt="Bata Blanca">
          <p> &nbsp;</p>
            <h3>BATA ALGODÓN (BLANCA)</h3>
            <p>40 unidades</p>
        </div>
      </div>
      <div class= "col-xs-10 col-sm-6 col-md-4 product">
        <div class = "card">
          <img src="/5L/Proyecto/f2/anexos/img/batapaciente.jpg" alt="Bata Azul">
          <p> &nbsp;</p>
            <h3>BATA PACIENTE AZUL</h3>
            <p>40 unidades</p>
        </div>
      </div>
      <div class= "col-xs-10 col-sm-6 col-md-4 product">
        <div class = "card">
          <img src="/5L/Proyecto/f2/anexos/img/alcohol.png" alt="alcohol">
          <p> &nbsp;</p>  
          <h3>ALCOHOL GLICERINADO</h3>
            <p>40 unidades</p>
        </div>
      </div>
      <div class= "col-xs-10 col-sm-6 col-md-4 product">
        <div class = "card">
          <img src="/5L/Proyecto/f2/anexos/img/alcoholquirurgico.jpg" alt="alcohol2">
          <p> &nbsp;</p>  
          <h3>ALCOHOL ANTISEPTICO</h3>
            <p>40 unidades</p>
        </div>
      </div>
      <div class= "col-xs-10 col-sm-6 col-md-4 product">
        <div class = "card">
          <img src="/5L/Proyecto/f2/anexos/img/desinfectante.jpg" alt="desinfectante">
          <p> &nbsp;</p>  
          <h3>TOALLITAS DESINFECTACTES </h3>
            <p>40 unidades</p>
        </div>
      </div>
      <div class= "col-xs-10 col-sm-6 col-md-4 product">
        <div class = "card">
          <img src="/5L/Proyecto/f2/anexos/img/gorrodesechable.jpg" alt="gorro">
          <p> &nbsp;</p>  
          <h3>GORRO DESECHABLE AZUL</h3>
            <p>40 unidades</p>
        </div>
      </div>
      <div class= "col-xs-10 col-sm-6 col-md-4 product">
        <div class = "card">
          <img src="/5L/Proyecto/f2/anexos/img/macrogoteo.jpg" alt="goteo">
          <p> &nbsp;</p>  
          <h3>EQUIPO MACROGOTEO</h3>
            <p>40 unidades</p>
        </div>
      </div>
      <div class= "col-xs-10 col-sm-6 col-md-4 product">
        <div class = "card">
          <img src="/5L/Proyecto/f2/anexos/img/tapabocas.jpg" alt="tapabocas">
          <p> &nbsp;</p>  
          <h3>TAPABOCAS N95</h3>
            <p>40 unidades</p>
        </div>
      ...
      <div class= "col-xs-10 col-sm-6 col-md-4 product">
        <div class = "card">
          <img src="/5L/Proyecto/f2/anexos/img/guantes.jpg" alt="guantes">
          <p> &nbsp;</p>  
          <h3>GUANTES QUIRURGICOS</h3>
            <p>40 unidades</p>
        </div>
      </div>
